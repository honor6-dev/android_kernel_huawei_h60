...
enum hw_device_type {
    ...
    DEV_I2C_PMU_DCDC,// 22
    DEV_I2C_CAMERA_PMU, //23
    DEV_I2C_CPU_CHIP,// 24
    DEV_I2C_MAX,// 25
    DEV_CONNECTIVITY_START,
    DEV_CONNECTIVITY_WIFI = DEV_CONNECTIVITY_START,// 26
    DEV_CONNECTIVITY_BT,// 27
    DEV_CONNECTIVITY_FM,// 28
    DEV_CONNECTIVITY_GPS,// 29
    DEV_CONNECTIVITY_GPU,//30
    DEV_CONNECTIVITY_MAX,// 31
};
