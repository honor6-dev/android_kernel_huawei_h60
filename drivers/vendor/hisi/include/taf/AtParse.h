...
#define AT_PARA_SCALE_MAX_LEN                   (20)
...
#if (FEATURE_ON == FEATURE_LTE)
#define CGTFT_CMD_PARA_STRING           "(1-31),(1-16),(0-255),(IpMask),(0-255),(Dpr),(Spr),(0-4294967295),(TosM),(0-1048575),(0-3)"
#else
...
#if (FEATURE_ON == FEATURE_LTE)
#define NDISDUP_TEST_CMD_PARA_STRING    "(1-20),(0,1),(apn),(username),(passwd),(1,2,3),(ipAddr)"
#else
#define NDISDUP_TEST_CMD_PARA_STRING    "(1-16),(0,1),(apn),(username),(passwd),(1,2,3),(ipAddr)"
#endif
