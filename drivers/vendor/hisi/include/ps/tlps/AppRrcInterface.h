...
enum APP_RRC_MSG_ID_ENUM
{
    ...
    ID_APP_RRC_LSCCINFO_REQ             = (PS_MSG_ID_APP_TO_RRC_BASE + 0x18),
    ...
    ID_APP_RRC_LSCCINFO_CNF                 = (PS_MSG_ID_RRC_TO_APP_BASE + 0x43),
...
typedef struct
{
    ...
    VOS_UINT32                          ulOpId;
    VOS_UINT32                          ulRsv;      
} APP_RRC_LSCCINFO_REQ_STRU;
/*****************************************************************************
 结构名    : RRC_APP_LSCCINFO_PARA_STRU
结构说明  : RRC上报的消息
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 结构说明  :
*****************************************************************************/
#define APP_SCC_MAX_NUM     (1)
//APP_SCC_MAX_NUM必须等于LRRC_LPHY_MAX_SECONDARY_CARRIER_NUM
typedef struct
{
    VOS_MSG_HEADER                                      /*_H2ASN_Skip*/
    VOS_UINT32                          ulMsgId;        /*_H2ASN_Skip*/
    ...
    VOS_UINT32                          ulOpId;         /* MSP直接将此ID做为CmdID发给Prob */
    VOS_UINT32                          ulSccCnt;       
    RRC_APP_LSCCINFO_PARA_STRU          stLSccinfoPara[APP_SCC_MAX_NUM];
} RRC_APP_LSCCINFO_CNF_STRU;
