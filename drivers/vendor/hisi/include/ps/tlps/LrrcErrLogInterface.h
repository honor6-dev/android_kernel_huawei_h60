...
/*****************************************************************************
 结构名    : LRRC_OM_AREA_LOST_ERROLOG_STRU
 结构说明  : 记录最后四次发生丢网的信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              ulNextIndex;                                    /*astAreaLostInfo有效数据个数 */
    LRRC_OM_AREA_LOST_INFO_STRU             astAreaLostInfo[RRC_ERRLOG_AREA_LOST_MAX_NUM];  /* 丢网信息 */
    LRRC_APP_ERR_LOG_RAT_TYPE_ENUM_UINT8    enRatType;                                      /* 丢网发生时的接入技术 */
    VOS_UINT8                               aucResv[3];
}RRC_OM_AREA_LOST_ERROLOG_STRU;
/* ErrorLog新增丢网信息end */
...
typedef struct
{
    ...
    RRC_OM_AREA_LOST_ERROLOG_STRU    stRrcAreaLostInfo;      /* 丢网时，记录服务小区信息 */
