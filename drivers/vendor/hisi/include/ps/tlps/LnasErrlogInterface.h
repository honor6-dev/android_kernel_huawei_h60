...
enum LNAS_OM_ERRLOG_ID_ENUM
{
    ...
    LNAS_OM_ERRLOG_ID_CN_CAUSE_IMSI_PAGING,                                         /* 网络侧发起了imsi类型的paging*/
    LNAS_OM_ERRLOG_ID_CN_CAUSE_REVERSE_WAIT_SYSINFO_TIMEOUT,                        /* 异系统回退等待系统消息超时*/
...
enum    LMM_ERRLOG_INFO_TYPE_ENUM
{
    ...
    LMM_ERR_LOG_ATTACH_PROCEDURE         = 1,    /* ATTACH类型*/
    LMM_ERR_LOG_TAU_PROCEDURE,                   /* TAU类型 */
    LMM_ERR_LOG_SERVICE_PROCEDURE,               /* SERVICE类型 */
    LMM_ERR_LOG_DETACH_PROCEDURE,                /* DETACH类型 */
    LMM_ERR_LOG_IMSI_PAGING_PROCEDURE,           /* 网络侧发起的IMSI paging*/
    LMM_ERR_LOG_REVERSE_WAIT_SYSINFO_TIMEOUT_PROCEDURE,    /*异系统回退等待定时器超时*/
