...
enum LRRC_LPHY_MSG_ID_ENUM
{
	...
	/* LCS Begin */
    ID_LRRC_LPHY_OTDOA_REQ                        = (ERRC_LPHY_MSG_HDR + 0x18), /* _H2ASN_MsgChoice LRRC_LPHY_OTDOA_REQ_STRU */
    ID_LRRC_LPHY_ECID_REQ                         = (ERRC_LPHY_MSG_HDR + 0x19), /* _H2ASN_MsgChoice LRRC_LPHY_ECID_REQ_STRU */
	/* LCS End */
	...
	/* LCS Begin */
    ID_LRRC_LPHY_OTDOA_IND                        = (LPHY_ERRC_MSG_HDR + 0x1c), /* _H2ASN_MsgChoice LRRC_LPHY_OTDOA_IND_STRU */
    ID_LRRC_LPHY_ECID_IND                         = (LPHY_ERRC_MSG_HDR + 0x1d), /* _H2ASN_MsgChoice LRRC_LPHY_ECID_IND_STRU */
    ID_LRRC_LPHY_LCS_GAP_REQ                      = (LPHY_ERRC_MSG_HDR + 0x1e), /* _H2ASN_MsgChoice LRRC_LPHY_LCS_GAP_REQ_STRU */
    /* LCS End */
...
{
    LRRC_LPHY_POSITION_OTDOA_MEAS_STOP,
    LRRC_LPHY_POSITION_OTDOA_MEAS_START,
...
{
    LRRC_LPHY_OTDOA_DL_SF_0,
    LRRC_LPHY_OTDOA_DL_SF_1,
    LRRC_LPHY_OTDOA_DL_SF_2,
    LRRC_LPHY_OTDOA_DL_SF_3,
    LRRC_LPHY_OTDOA_DL_SF_4,
    LRRC_LPHY_OTDOA_DL_SF_5,
...
typedef struct
{
    ...
    /* v7r2 interface begin */
    #if 0
    VOS_UINT32                            ausCodebookSubsetRestriction[2];      /* 码书的子集受限,Little-Endian字节序 */
    #endif
...
typedef struct
{
    ...
    /* MBMS Begin */
    #if 0
    LRRC_LPHY_MBSFN_SUBFRAME_CFG_LIST_STRU  stMbsfnCfgInfo;                     /* MBSFN子帧配置信息 */
    #endif
...
typedef struct
{
    ...
    LRRC_LPHY_CELL_MEAS_RESULT_STRU     astCellMeasResult[LRRC_LPHY_MAX_FREQ_CELL_NUM];/* SCELL放在第一个的位置 */
...
typedef struct
{
    ...
    VOS_UINT16                            usShortDrxCycleTimer;                   /* shortDRX->drxShortCycleTimer */
...
/*****************************************************************************
 结构名    : LRRC_LPHY_ECID_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_ECID_REQ_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
...
}LRRC_LPHY_ECID_REQ_STRU;

/*****************************************************************************
 结构名    : LRRC_LPHY_ECID_MEAS_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_ECID_MEAS_RESULT_STRU数据结构
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT16                                          usEarfcn;
    VOS_UINT16                                          usSFN;
    VOS_UINT16                                          usRSRPResult;
    VOS_UINT16                                          usRSRQResult;
    VOS_UINT16                                          usUERxTxTimeDiff;
}LRRC_LPHY_ECID_MEAS_RESULT_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                           aucReservered[2];
    LRRC_LPHY_ECID_MEAS_RESULT_STRU                     astNeighbourCellMeasResults[LRRC_LPHY_ECID_MAX_NEIGHBOUR_CELL_NUM];
}LRRC_LPHY_ECID_MEAS_RESULT_LIST_STRU;

/*****************************************************************************
 结构名    : LRRC_LPHY_ECID_SIGNAL_MEAS_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_ECID_SIGNAL_MEAS_INFO_STRU数据结构
*****************************************************************************/
typedef struct
{
    LRRC_LPHY_ECID_MEAS_RESULT_STRU                       stPrimaryCellMeasResult;
    LRRC_LPHY_ECID_MEAS_RESULT_LIST_STRU                  stNeighbourCellMeasResultsList;
}LRRC_LPHY_ECID_SIGNAL_MEAS_INFO_STRU;

/*****************************************************************************
 结构名    : LRRC_LPHY_ECID_PROVIDE_LOCATION_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_ECID_PROVIDE_LOCATION_INFO_STRU数据结构
*****************************************************************************/
typedef struct
{
    LRRC_LPHY_ECID_SIGNAL_MEAS_INFO_STRU                    stSignalMeasInfo;
    LRRC_LPHY_ECID_TARGET_DEVICE_ERROR_CAUSES_ENUM_UINT16   enCause;
    VOS_UINT8                                               aucReservered[2];
}LRRC_LPHY_ECID_PROVIDE_LOCATION_INFO_STRU;

/*****************************************************************************
 结构名    : LRRC_LPHY_ECID_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_ECID_IND_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                              ulMsgId;
    VOS_UINT16                                              usOpld;
    VOS_UINT8                                               aucReservered[2];
    LRRC_LPHY_ECID_PROVIDE_LOCATION_INFO_STRU               stEcidMeasInfo;
}LRRC_LPHY_ECID_IND_STRU;
...
/*****************************************************************************
 结构名    : LRRC_LPHY_MBX_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_MBX_STRU数据结构
*****************************************************************************/
typedef struct
{
...
typedef struct
{
    ...
    VOS_UINT16                                              usEarfcnNeighbour;
    VOS_UINT16                                              usRSTDResult;
    VOS_UINT8                                               aucReservered[2];
...
/*****************************************************************************
 结构名    : LRRC_LPHY_MBSFN_AREA_INFO_LIST_CFG_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_MBSFN_AREA_INFO_LIST_CFG_REQ_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
...
/*****************************************************************************
 结构名    : LRRC_LPHY_MBSFN_AREA_INFO_LIST_CFG_CNF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_MBSFN_AREA_INFO_LIST_CFG_CNF_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
...
/*****************************************************************************
 结构名    : LRRC_LPHY_MBSFN_AREA_CFG_INFO_LIST_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_MBSFN_AREA_CFG_INFO_LIST_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
...
typedef struct
{
    ...
    VOS_UINT8                                           ucSarReductionPri;      /*功率回退等级*/
