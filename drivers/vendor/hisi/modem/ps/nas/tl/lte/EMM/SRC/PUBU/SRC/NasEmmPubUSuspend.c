...
VOS_VOID  NAS_EMM_SendEsmSuspendInd( VOS_VOID )
{
    ...
    {
        /* 打印异常，ERROR_LEVEL */
        NAS_EMM_PUBU_LOG_NORM("NAS_EMM_SendEsmSuspendInd: MSG ALLOC ERROR!!!");
        return ;
    }
...
VOS_VOID  NAS_EMM_SendErabmSuspendInd( VOS_VOID )
{
    ...
    {
        /* 打印异常，ERROR_LEVEL */
        NAS_EMM_PUBU_LOG_NORM("NAS_EMM_SendErabmSuspendInd: MSG ALLOC ERROR!!!");
        return ;
    }
...
VOS_VOID  NAS_EMM_SendLrrcSuspendReq( VOS_VOID )
{
    ...
    {
        /* 打印异常，ERROR_LEVEL */
        NAS_EMM_PUBU_LOG_NORM("NAS_EMM_SendLrrcSuspendReq: MSG ALLOC ERROR!!!");
        return ;
    }
...
VOS_VOID  NAS_EMM_SndLrrcSuspendRelReq( VOS_VOID )
{
    ...
    {
        /* 打印异常，ERROR_LEVEL */
        NAS_EMM_PUBU_LOG_NORM("NAS_EMM_SndLrrcSuspendRelReq: MSG ALLOC ERROR!!!");
        return ;
    }
...
VOS_VOID  NAS_EMM_SendLrrcSuspendRsp( LRRC_LNAS_RESULT_ENUM_UINT32 ulRst )
{
    ...
    {
        /* 打印异常，ERROR_LEVEL */
        NAS_EMM_PUBU_LOG_NORM("NAS_EMM_SendLrrcSuspendRsp: MSG ALLOC ERROR!!!");
        return ;
    }
...
VOS_UINT32  NAS_LMM_ProcRrcSysCfgCnfNotSuspend(VOS_VOID)
{
    ...
    if (NAS_LMM_CUR_LTE_ACTIVE == NAS_EMM_GetCurLteState())
    {
        ...
        if (EMM_MS_RRC_CONN_EST_INIT == NAS_EMM_CUR_MAIN_STAT)
        {
            /* 停止 定时器*/
