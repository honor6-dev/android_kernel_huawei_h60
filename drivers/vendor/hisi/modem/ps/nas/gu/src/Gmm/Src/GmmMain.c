                                                ...
                                                VOS_UINT32  ulMsgLen)
{
    ...
    else
    {
        ...
        /* 如果RAI没有发生改变 */
        if (GMM_TRUE == Gmm_Com_CmpRai(&stRauRai, g_GmmGlobalCtrl.ucNetMod))
        {
            /* 没有分配PTMSI */
...
VOS_VOID Gmm_RcvCoverLost_RauInit()
{
    ...
    {                                                                           /* ucRauAttmptCnt小于5                      */
        ...
        if ((GMM_TRUE == Gmm_Com_CmpRai(&stRai, g_GmmGlobalCtrl.ucNetMod))
...
VOS_VOID Gmm_RcvCmServReq_RegAtmpToUpdt(VOS_VOID *pMsg)
{
    ...
    else if ( (WUEPS_PID_SM == pMsgHeader->ulSenderPid)
 ...
 */
    ...
    Gmm_Get_Location_Change_info(pRaiTemp, &g_GmmGlobalCtrl.SysInfo.Rai, &ucLaiChgFlg, &ucRaiChgFlg, ucNetMod);
...
VOS_VOID Gmm_ComNetModeChange(VOS_VOID  *pMsg)
{
    ...
    if (GMM_FALSE == Gmm_Com_CmpRai(pRaiTemp, ucNetMod))
    {                                                                           /* 设置RAI是否变化标志                      */
...
VOS_VOID Gmm_ComNetModeChangeGsm(VOS_VOID  *pMsg)
{
    ...
    if (GMM_FALSE == Gmm_Com_CmpRai(pRaiTemp, pSysInfoInd->ucNetworkOperationMode))
    {                                                                           /* 设置RAI是否变化标志                      */
        ucRaiChgFlg                 = GMM_TRUE;
        g_GmmRauCtrl.ucRauAttmptCnt = 0;
    }
