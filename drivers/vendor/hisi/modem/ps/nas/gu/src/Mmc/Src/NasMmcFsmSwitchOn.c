...
)
{
    ...
    vos_printf("NAS_MMC_RcvWasStartCnf_SwitchOn_WaitWasStartCnf.ulResult = %d.tick=%d\n ", pstRrStartCnfMsg->ulResult,OM_GetSlice());
...
)
{
    ...
    vos_printf("NAS_MMC_RcvLmmStartCnf_SwitchOn_WaitLStartCnf.ulResult = %d,tick=%d\r\n ", pstRrStartCnfMsg->ulRst,OM_GetSlice());
...
VOS_VOID NAS_MMC_ReadNvimInfo_SwitchOn()
{
    ...
    /* en_NV_Item_User_Cfg_Ehplmn_Info */
    NAS_MMC_ReadUserCfgEhplmnInfoNvim();
