...
VOS_VOID NAS_GMM_SaveDetachMsg(VOS_VOID *pMsg)
{
    ...
    {
          PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_SaveDetachMsg:ERROR: Allocate memory error in Gmm_RcvMmcDetachReq");
          return;
    }
...
)
{
      ...
      && ((VOS_NULL_PTR            != g_GmmGlobalCtrl.MsgHold.ulMsgAddrForDetach)) )
    {
         ...
         /* 获取缓存的DETACH类型 */
         ulGmmDetach = pstMsDetach->enDetachCause;
...
)
{
    ...
    ulDetachType = pMsDetach->enDetachCause;
...
)
{
    ...
    MMC_GMM_DETACH_CAUSE_ENUM_UINT32    enDetachCause;
    ...
    /* 默认当前启动的PS域DETACH */
    enDetachCause         = MMC_GMM_PS_DETACH;

    enDetachCause         = pstMsg->enDetachCause;

    /* 如果当前不需要PS域的DETACH，则直接返回 */
    if ( MMC_GMM_PS_DETACH != (enDetachCause & MMC_GMM_PS_DETACH) )
    {
        return;
    }
...
VOS_VOID NAS_GMM_GprsLocalDetach_SvltePsTransfer(VOS_VOID)
{
    switch (g_GmmGlobalCtrl.ucState)
    {
        ...
        default:
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
            break;
    }
                         ...
                         )
{
    ...
    pMsDetach    = (MMCGMM_DETACH_REQ_STRU *)pMsg;                              /* 初始化指针                               */
    ulDetachType = pMsDetach->enDetachCause;                                    /* 初始化detach类型                         */
    ...
    default:
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcDetachReq:WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
        break;
    }
...
)
{
    ...
    case MMC_GMM_PS_CS_DETACH:                                                  /* combined detach                          */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsInitNormalDetach:INFO: combined detach procedure started");
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_MsInitNormalDetach:NORMAL: STATUS IS GMM_DEREGISTERED_INITIATED");
    ...
    case MMC_GMM_PS_DETACH:                                                     /* GPRS detach                              */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsInitNormalDetach:INFO: normal detach procedure start");
    ...
    case MMC_GMM_CS_DETACH:                                                     /* IMSI detach                              */
        ...
        && (GMM_NET_MODE_I == g_GmmGlobalCtrl.SysInfo.ucNetMod))
        {
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsInitNormalDetach:INFO: IMSI detach procedure started");
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_MsInitNormalDetach:NORMAL: STATUS IS GMM_REGISTERED_IMSI_DETACH_INITIATED");

            g_MmSubLyrShare.GmmShare.ucDeatchEnableFlg = GMM_DETACH_ABLE;
        }
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_MsInitNormalDetach:WARNING: Detach Type is Abnormal");
        break;
    }
...
)
{
     ...
     || (VOS_TRUE == gstGmmCasGlobalCtrl.ucRauCmpFlg))
    {
        ...
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_ProcDetachReq_RegNmlServ:ERROR: Allocate memory error in Gmm_RcvMmcDetachReq");
              return;
        }
                           ...
                           )
{
    ...
    {                                                                           /* 状态是GMM-流程-INITIATED                 *
        ...
        if (VOS_NULL_PTR == ptr)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcPowerOffReq:WARNING: STATUS IS GMM_REGISTERED_IMSI_DETACH_INITIATED");
            return;
        }
    ...
    {                                                                           /* A+I                                      */
        ...
        {                                                                       /* MM和GMM均注册                            */
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcPowerOffReq:INFO: combined detach(power off) procedure started");
        ...
        {                                                                       /* MM未注册,GMM注册                         */
            ...
            {                                                                   /* 当前流程不是combined                     */
                ...
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcPowerOffReq:INFO: normal detach(power off) procedure started");
            }
        }
        else
        {                                                                       /* GMM未注册                                */
            ...
            {                                                                   /* 其他状态                                 */
                ...
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcPowerOffReq:INFO: specific procedure ended");
                return;
            }
        }
    }
...
VOS_VOID Gmm_PowerOffDetach(VOS_VOID)
{
      ...
      || (GMM_REGISTERED_PLMN_SEARCH  == g_GmmGlobalCtrl.ucState) )
    {
        ...
        {                                                                       /* 当前流程是SIM REMOVE                     */
            ...
            g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                    /* 清当前流程                               */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Tim5sExpired:INFO: specific procedure ended");
    ...
    else
    {
        ...
        {                                                                       /* 当前不存在信令连接                       */
            ...
            GMM_CasFsmStateChangeTo(GMM_DEREGISTERED_NORMAL_SERVICE);
            /* END:   Added by liurui id:40632, 2006/4/5   PN:A32D02352 */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_PowerOffDetach:NORMAL: STATUS IS GMM_DEREGISTERED_NORMAL_SERVICE");
...
NAS_MSG_STRU* Gmm_DetachRequestMsgMake(VOS_VOID)
{
    ...
    case GMM_DETACH_NORMAL_SIM_REMOVE:                                          /* GPRS detach with sim removing            */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_DetachRequestMsgMake:WARNING: g_GmmGlobalCtrl.ucSpecProc is Abnormal");
                             ...
                             )
{
    ...
    {                                                                           /* 消息中必选项的长度不够                   */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachRequestMsg:WARNING: Length of DETACH REQUEST is invalid");
    ...
    /* V200R001 Modify End: */
    {                                                                           /* Force to standby                         */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachRequestMsg:WARNING: DETACH REQUEST is semantically incorrect");
    ...
    NAS_MMC_NwDetachIndRecord(ucDetachType, ucGmmCause, ucForceToStandby);
#endif
    ...
    case GMM_REGISTERED_IMSI_DETACH_INITIATED:                                  /* GMM-REGISTERED.IMSI-DETACH-INITIATED     */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachRequestMsg:WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
        break;
    }
                                     ...
                                     )
{
    ...
    {                                                                           /* detach类型是"re-attach not required"     */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvDetachRequestMsg_RegInit:INFO: specific procedure ended");
    }
...
{
    if ((GMM_NET_DETACH_REATTACH_NOT_REQUIRED == ucDetachType)
        || (GMM_NET_DETACH_REATTACH_REQUIRED  == ucDetachType))
    {                                                                           /* detach类型为"re-attach not required"
        ...
        g_GmmReqCnfMng.ucCnfMask   = 0;                                         /* 清除等待CNF标志                          */
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清除当前进行的specific过程               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvDetachRequestMsg_RauInit:INFO: specific procedure ended");
                                         ...
                                         )
{
    ...
    g_GmmReqCnfMng.ucCnfMask = 0;                                               /* 清除等待CNF标志                          */
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清除当前进行的specific过程               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvDetachRequestMsg_ServReqInit:INFO: specific procedure ended");
    ...
    case GMM_NET_DETACH_IMSI_DETACH:                                            /* IMSI detach                              */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachRequestMsg_ServReqInit:WARNING: Detach Type is Abnormal");
        break;
    }
                                        ...
                                        )
{
    ...
    case GMM_NET_DETACH_IMSI_DETACH:                                            /* IMSI detach                              */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachRequestMsg_RegNmlServ:WARNING: Detach Type is Abnormal");
        break;
    }
                                  ...
                                  )
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:                              /* 原因值14                                 */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_NetInitNotRequiredDetach:WARNING: GMM Cause is Abnormal");
                            ...
                            )
{
    ...
    {                                                                           /* 消息中必选项的长度不够长                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachAcceptMsg:WARNING: Length of DETACH ACCEPT is invalid");
        pGmmStatus = Gmm_GmmStatusMsgMake(NAS_MML_REG_FAIL_CAUSE_INVALID_MANDATORY_INF);
    ...
    /* V200R001 Modify End: */
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachAcceptMsg:WARNING: DETACH ACCEPT is semantically incorrect");
        /* BEGIN: Modified by liurui id:40632, 2006/4/11   PN:A32D03037 */
    ...
    case GMM_REGISTERED_IMSI_DETACH_INITIATED:                                  /* GMM-REGISTERED.IMSI-DETACH-INITIATED     */
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvDetachAcceptMsg:WARNING: DETACH ACCEPT is unexpected");
...
VOS_VOID Gmm_RcvDetachAcceptMsg_DeregInit(VOS_VOID)
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvDetachAcceptMsg_DeregInit:INFO: specific procedure ended");
    return;                                                                     /* 返回                                     */
}
VOS_VOID Gmm_RcvDetachAcceptMsg_RegImsiDtchInit(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc               = GMM_NULL_PROCEDURE;              /* 清除当前进行的specific过程               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvDetachAcceptMsg_RegImsiDtchInit:INFO: specific procedure ended");
    return;                                                                     /* 返回                                     */
}
