...
typedef struct
{
    tagUDI_DEVICE_ID_UINT32         enAcmChannelId;   /* 目前HSIC AT通道所用的HSIC ACM通道ID为:
...
extern VOS_UINT32 AT_CheckUsbcomUser(VOS_UINT8 ucIndex);
extern VOS_UINT32 AT_CheckCtrUser(VOS_UINT8 ucIndex);
...
extern VOS_VOID AT_DisplayVcomInputData(
           VOS_UINT8                           ucIndex,
           VOS_UINT8                          *pData,
           VOS_UINT16                          usLen
       );
...
extern VOS_VOID AT_RcvMuxCmdStream_PreProc(
           VOS_UINT8                           ucIndex,
           VOS_UINT8                          *pData,
           VOS_UINT16                          usLen
       );
...
VOS_UINT32 AT_UART_ProcDtrChange(VOS_UINT8 ucIndex, AT_DCE_MSC_STRU *pMscStru);
