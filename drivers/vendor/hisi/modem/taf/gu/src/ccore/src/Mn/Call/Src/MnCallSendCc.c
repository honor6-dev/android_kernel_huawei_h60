...
VOS_UINT32  MN_CALL_SendCcRejReq(
    MN_CALL_ID_T                        callId,
    MN_CALL_CC_CAUSE_ENUM_U8            enCause
)
{
...
/*****************************************************************************
 ...
 修改历史      :
  1.日    期   : 2007年9月20日
    ...
    修改内容   : 新生成函数
*****************************************************************************/
VOS_UINT32  MN_CALL_SendCcHoldReq(
    MN_CALL_ID_T                        callId
)
{
/*
...
/*****************************************************************************
 ...
 修改历史      :
  1.日    期   : 2007年9月20日
    ...
    修改内容   : 新生成函数
*****************************************************************************/
VOS_UINT32  MN_CALL_SendCcRetrieveReq(
    MN_CALL_ID_T                        callId
)
{
/*
...
VOS_UINT32  MN_CALL_SendCcActCcbsReq(
    MN_CALL_ID_T                        callId
)
{
/*
...
/*****************************************************************************
 ...
 修改历史      :
  1.日    期   : 2007年9月20日
    ...
    修改内容   : 新生成函数
*****************************************************************************/
VOS_UINT32  MN_CALL_SendCcDeflectFacility(
    MN_CALL_ID_T                        callId,
