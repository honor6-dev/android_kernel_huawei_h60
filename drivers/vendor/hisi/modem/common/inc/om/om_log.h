...
/*****************************************************************************
 实体名称  : OM_ERR_LOG_DIAG_STRU
 功能描述  : 语音检测模块上报的故障或告警数据结构
 *****************************************************************************/
typedef struct
{
    OM_ERR_LOG_HEADER_STRU              stOmErrLogHeader;
    VOS_UINT16                          auhwContent[4];                         /* 故障或告警内容 */
}OM_ERR_LOG_DIAG_STRU;

/*****************************************************************************
 实体名称  : HIFI_ERROR_EVENT_ONE_WAY_NO_SOUND_STRU
 功能描述  : 语音单通时对应的HIFI故障结构体
 *****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 实体名称  : HIFI_ERR_EVT_VOICE_CONTROL_FAULT_STRU
 功能描述  : HIFI内部语音流程异常告警结构体
 *****************************************************************************/
typedef struct
{
    VOS_UINT16              uhwErrorReason;                                     /*语音异常原因*/
    VOS_UINT16              uhwDevMode;                                         /*语音设备类型*/
    VOS_UINT16              uhwActiveModem;                                     /*当前激活的Modem号*/
    VOS_UINT16              uhwNetMode;                                         /*网络制式*/
    VOS_UINT16              uhwCodecType;                                       /*编解码器类型*/
    VOS_UINT16              uhwTxDmaErr;                                        /*上行DMA异常标志位*/
    VOS_UINT16              uhwRxDmaErr;                                        /*下行DMA异常标志位*/
    VOS_UINT16              uhwReaerve[5];                                      /*附加信息*/
}HIFI_ERR_EVT_VOICE_CONTROL_FAULT_STRU;

/*****************************************************************************
 实体名称  : HIFI_ERR_EVT_VOICE_SUSPEND_SLOW_STRU
 功能描述  : CS语音异系统切换时间过长告警结构体
 *****************************************************************************/
typedef struct
{
    VOS_UINT16              uhwErrorReason;                                     /*语音异常原因*/
    VOS_UINT16              uhwActiveModem;                                     /*当前激活的Modem号*/
    VOS_UINT16              uhwCurNetMode;                                      /*当前网络制式*/
    VOS_UINT16              uhwPreNetMode;                                      /*切换前网络制式*/
    VOS_UINT32              uwSuspendTime;                                     /*网络切换期间语音软件被暂停时长*/
