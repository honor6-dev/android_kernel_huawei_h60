...
#define VOICE_DIAG_TIMESTAMP_MS_RATIO           (10000)              /*1s与0.1ms的转换*/

#define ERR_LOG_ALARM_REPORT_ENABLE             (0x80)             /* 10000000 主动上报使能 */
...
typedef struct
{
    VOS_UINT16 uhwTxDmaIsrFlag;     /* 是否收到上行DMA中断 */
    VOS_UINT16 uhwRxDmaIsrFlag;     /* 是否收到下行DMA中断 */
