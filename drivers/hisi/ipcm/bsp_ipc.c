...
/*************************************hifi系统ipc******************************************/
#define K3_SYS_IPC_BASE_ADDR_S      (0xe8610000)
#define K3_SYS_IPC_BASE_ADDR_NS    (0xe8611000)
...
#define K3_SYS_IPC_CORE_HIFI                        (4)
	...
	/*************************************hifi内部ipc******************************************/
#define K3_HIFI_IPC_BASE_ADDR      (0xE804C000)
...
static int hisi_hifi_send_ipc(mbox_msg_t *msg, mbox_msg_len_t len)
{
	...
	tx_task = hisi_mbox_task_alloc(hifi_tx_mbox, HI3630_MAILBOX_RP_HIFI,
...
static int hisi_hifi_mbox_init(void)
{
	...
	if (!(hifi_tx_mbox = hisi_mbox_get(HI3630_MAILBOX_RP_HIFI, &rx_nb))) {
