...
#define CP_REGS_SIZE (1024*8) //4*1024 VPP;4*1024 MMU
#define REG_BASE_VPP 0xE8968000

u8 __iomem *s_xl_mmio = NULL;

#define VPP_REG(__B__,__O__)   (*((unsigned volatile*)(__B__ + (unsigned int)__O__)))
