...
#define POWERUP_MAX_RETRY	15 /* how many times we retry to power up the chip */
#endif
...
#define DEFAULT_ROAM_TRIGGER_VALUE -75 /* dBm default roam trigger 2.4 band */
...
typedef int (*f_droppkt_t)(dhd_pub_t *dhdp, int prec, void* p, bool countdown);
...
#define PRODUCT_NVRAM_PATH  "/vendor/firmware/%s"
#define PRODUCT_FIRMWARE_PATH  "/vendor/firmware/%s"
#define NVRAM_PATH_LEN   128
#define FIRMWARE_PATH_LEN   128
#define NVRAM_NAME_LEN 50
#define FIRMWARE_NAME_LEN  50
extern char g_fw_name[FIRMWARE_NAME_LEN]; //get name from dts
extern char g_nvram_name[NVRAM_NAME_LEN]; //get name from dts
