...
static struct of_device_id tfa9887_i2c_dt_ids[] = {
    {.compatible = "hisilicon,tfa9887" },
    {}
};
...
{
    return misc_deregister(&tfa9887_device);
}
...
MODULE_DEVICE_TABLE(of, tfa9887_i2c_dt_ids);
...
static struct i2c_driver tfa9887_driver = {
    ...
    .driver     = {
        .owner = THIS_MODULE,
        .name  = TFA9887_NAME,
        .of_match_table = of_match_ptr(tfa9887_i2c_dt_ids),
    },
};
