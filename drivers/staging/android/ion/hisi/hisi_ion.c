...
extern unsigned long hisi_reserved_cpu_draw_phymem;
extern unsigned long hisi_reserved_cpu_draw_phymem_size;

extern unsigned long hisi_reserved_graphic_phymem;
extern unsigned long hisi_reserved_graphic_phymem_size;

extern unsigned long hisi_reserved_misc_phymem;
extern unsigned long hisi_reserved_misc_phymem_size;
...
static void hisi_ion_get_heap(void)
{
	...
	/* gralloc and cpudraw heap use carveout memory,
	   we need to initialize base and size of them */
	for (i = 0; i < ARRAY_SIZE(hisi_ion_heaps); i++) {
		if (hisi_ion_heaps[i].id == ION_GRALLOC_HEAP_ID) {
			hisi_ion_heaps[i].base = hisi_reserved_graphic_phymem;
			hisi_ion_heaps[i].size = hisi_reserved_graphic_phymem_size;
		}
		if (hisi_ion_heaps[i].id == ION_CPU_DRAW_HEAP_ID) {
			hisi_ion_heaps[i].base = hisi_reserved_cpu_draw_phymem;
			hisi_ion_heaps[i].size = hisi_reserved_cpu_draw_phymem_size;
		}

		if (hisi_ion_heaps[i].id == ION_MISC_HEAP_ID) {
			hisi_ion_heaps[i].base = hisi_reserved_misc_phymem;
			hisi_ion_heaps[i].size = hisi_reserved_misc_phymem_size;
		}
