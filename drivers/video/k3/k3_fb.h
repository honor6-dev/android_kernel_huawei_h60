...
struct k3_fb_data_type {
	bool blank_in_suspend;
	/* Do not change the offset of blank_in_suspend,
	struct k3_fb_data_type is transparent in fbmem.c,
	reinterpret_cast<bool *>(k3_fb_data_type * ) can get this domain */
	bool panel_power_on;
	u32 index;
	u32 ref_cnt;
	u32 fb_num;
	...
	void (*mipi_freq_register) (struct platform_device *pdev);
	void (*mipi_freq_unregister) (struct platform_device *pdev);
