...
static int mipi_jdi_probe(struct platform_device *pdev)
{
	...
	pinfo->mipi.mipi_dsi_freq1 = 473;
	pinfo->mipi.mipi_dsi_freq2 = 480;
	pinfo->mipi.mipi_dsi_freq3 = 486;
	pinfo->mipi.mipi_dsi_freq4 = 492;
	pinfo->mipi.mipi_dsi_freq5 = 500;
	pinfo->mipi_emi_support = 1;
	pinfo->mipi.dsi_bit_clk_next = pinfo->mipi.dsi_bit_clk;
