...
static bool s_common_init_successfully = false;

/* 记录某类信息是否已经dump的位图，最多纪录64类信息 */
static unsigned long long s_log_type_bits = 0ULL;
...
{
    s_common_init_successfully = true;
...
{
    s_common_init_successfully = false;
}
