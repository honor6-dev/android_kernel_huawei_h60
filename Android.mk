...
KERNEL_PRODUCT_CONFIGS  := device/hisi/customize/hsad/config/$(HW_PRODUCT)/product_config/kernel_config
...
DTS_PARSE_CONFIG:
	...
	@cd device/hisi/customize/hsad/build_scripts; ./auto_dts_gen.sh
